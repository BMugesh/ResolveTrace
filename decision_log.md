...
* **Rationale**: This diagnostic correction dropped the true False Auto-Handling Rate from 9.7% down to **4.2%** at **68.6%** automation coverage, while lifting Pathway Selection Accuracy from 27.8% to **62.8%**, outperforming Semantic RAG (51.2%, McNemar exact $p = 0.0043$, $\chi^2 = 8.02$).
